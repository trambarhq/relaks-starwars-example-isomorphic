...
let routes = {
    ...
    'character-list': {
        path: '/characters/',
        load: async () => {
            params.module = await import('pages/character-list' /* webpackChunkName: "character-list" */);
        }
    },
    'character-summary': {
        path: '/characters/${id}/',
    ...
    'planet-list': {
        path: '/planets/',
        load: async () => {
            params.module = await import('pages/planet-list' /* webpackChunkName: "planet-list" */);
        }
    },
    'planet-summary': {
        path: '/planets/${id}/',
    ...
    'species-list': {
        path: '/species/',
        load: async () => {
            params.module = await import('pages/species-list' /* webpackChunkName: "species-list" */);
        }
    },
    'species-summary': {
        path: '/species/${id}/',
    ...
    'vehicle-list': {
        path: '/vehicles/',
        load: async () => {
            params.module = await import('pages/vehicle-list' /* webpackChunkName: "vehicle-list" */);
        }
    },
    'vehicle-summary': {
        path: '/vehicles/${id}/',
    ...
    'starship-list': {
        path: '/starships/',
        load: async () => {
            params.module = await import('pages/starship-list' /* webpackChunkName: "starship-list" */);
        }
    },
    'starship-summary': {
        path: '/starship/${id}/',
